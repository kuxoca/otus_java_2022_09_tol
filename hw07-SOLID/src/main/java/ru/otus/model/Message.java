...
public class Message {
    ...
    public Builder toBuilder() {
        return new Builder(id, field1, field2, field3, field4, field5, field6, field7, field8, field9, field10, field11, field12, copyObjectForMessage(field13));
    }
    ...
    private static ObjectForMessage copyObjectForMessage(ObjectForMessage objectForMessage) {
        ...
        List<String> data = objectForMessage != null && objectForMessage.getData() != null
                ? List.copyOf(objectForMessage.getData()) : Collections.emptyList();
        cloneObjectForMessage.setData(data);
